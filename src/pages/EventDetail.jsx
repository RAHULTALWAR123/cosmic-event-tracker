...
function EventDetail() {
    ...
    const getCurrentNeo = async() => {
        const res = await fetch(`https://api.nasa.gov/neo/rest/v1/neo/${id}?api_key=V4wsiuDPl2fgRtWyBz1If6cw9WLg0lGWLvE64JTl`)
    ...
    if (!neo) return <div className="flex justify-center items-center h-screen">Loading...</div>;
                    ...
                    <div className="p-6 md:p-8 border-b border-white/10">
                        <div className="flex flex-col md:flex-row justify-between items-start gap-4">
                            ...
                            <span className={`px-4 py-2 rounded-full text-sm font-semibold ${
                                ...
                                {neo.is_potentially_hazardous_asteroid ? '⚠️ Hazardous Asteroid' : '🛡️ Non-Hazardous'}
                            </span>
                        </div>
                    </div>
